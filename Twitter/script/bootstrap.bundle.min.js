...
!(function (t, e) {
  ...
  class De extends B {
    constructor(e, i) {
      super(e),
        (this._config = this._getConfig(i)),
        (this._dialog = t.findOne(".top-dialog", this._element)),
    ...
    show(t) {
      this._isShown ||
        ...
        P.trigger(this._element, "show.bs.top", { relatedTarget: t })
          .defaultPrevented ||
        ((this._isShown = !0),
        ...
        P.on(
          this._element,
          "click.dismiss.bs.top",
          '[data-bs-dismiss="top"]',
          (t) => this.hide(t)
        ),
        P.on(this._dialog, "mousedown.dismiss.bs.top", () => {
          P.one(this._element, "mouseup.dismiss.bs.top", (t) => {
    ...
    hide(t) {
      if (
        ...
        return;
      if (P.trigger(this._element, "hide.bs.top").defaultPrevented) return;
      this._isShown = !1;
      const e = this._isAnimated();
      e && (this._isTransitioning = !0),
        this._setEscapeEvent(),
        this._setResizeEvent(),
        P.off(document, "focusin.bs.top"),
        this._element.classList.remove("show"),
        P.off(this._element, "click.dismiss.bs.top"),
        P.off(this._dialog, "mousedown.dismiss.bs.top"),
        this._queueCallback(() => this._hidetop(), this._element, e);
    }
    dispose() {
      [window, this._dialog].forEach((t) => P.off(t, ".bs.top")),
    ...
    _showElement(e) {
      const i = this._isAnimated(),
        n = t.findOne(".top-body", this._dialog);
      (this._element.parentNode &&
        this._element.parentNode.nodeType === Node.ELEMENT_NODE) ||
        document.body.appendChild(this._element),
        (this._element.style.display = "block"),
        this._element.removeAttribute("aria-hidden"),
        this._element.setAttribute("aria-top", !0),
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._element.focus(),
              (this._isTransitioning = !1),
              P.trigger(this._element, "shown.bs.top", { relatedTarget: e });
          },
          this._dialog,
          i
        );
    ...
    _enforceFocus() {
      P.off(document, "focusin.bs.top"),
        P.on(document, "focusin.bs.top", (t) => {
          document === t.target ||
    ...
    _setEscapeEvent() {
      this._isShown
        ? P.on(this._element, "keydown.dismiss.bs.top", (t) => {
        ...
        : P.off(this._element, "keydown.dismiss.bs.top");
    }
    _setResizeEvent() {
      this._isShown
        ? P.on(window, "resize.bs.top", () => this._adjustDialog())
        : P.off(window, "resize.bs.top");
    }
    _hidetop() {
      (this._element.style.display = "none"),
        this._element.setAttribute("aria-hidden", !0),
        this._element.removeAttribute("aria-top"),
        ...
        this._backdrop.hide(() => {
          document.body.classList.remove("top-open"),
            ...
            P.trigger(this._element, "hidden.bs.top");
        });
    }
    _showBackdrop(t) {
      P.on(this._element, "click.dismiss.bs.top", (t) => {
    ...
    _triggerBackdropTransition() {
      if (P.trigger(this._element, "hidePrevented.bs.top").defaultPrevented)
        return;
      const { classList: t, scrollHeight: e, style: i } = this._element,
        n = e > document.documentElement.clientHeight;
      (!n && "hidden" === i.overflowY) ||
        t.contains("top-static") ||
  ...
  P.on(
    document,
    "click.bs.top.data-api",
    '[data-bs-toggle="top"]',
    function (t) {
      const e = s(this);
      ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
        P.one(e, "show.bs.top", (t) => {
          t.defaultPrevented ||
            P.one(e, "hidden.bs.top", () => {
              c(this) && this.focus();
            });
        }),
  ...
  class Fe extends B {
    ...
    dispose() {
      clearTimeout(this._timeout),
        P.off(
          this._element.closest(".top"),
          "hide.bs.top",
          this._hidetopHandler
        ),
